        ...
        while (!stack.isEmpty()) {
            ...
            if (!visited.contains(current)) {
                ...
                steps.add(new GraphSimulationResponse.Step(
                 ...
                 // Even if visited, we might want to record a step showing we processed it, 
                 // but typically in simplified visualization we just skip or maybe show it briefly.
                 // For now, let's only record effective visits to match standard educational demos.
                 // However, to show the stack changing (popping), we might want a step.
                 // Let's stick to recording meaningful steps where 'current' is processed.
            }
        }
